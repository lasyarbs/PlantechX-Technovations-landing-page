          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => (
              <button
                ...
                className="font-medium transition-colors duration-200 text-sm hover:text-white"
                style={{ color: '#C7C7C7' }}
              >
                {item.label}
              </button>
          ...
          <div className="md:hidden bg-black/60 backdrop-blur-xl border-t border-white/10">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button
                ...
                className="w-full text-left text-white px-3 py-2 rounded-md hover:shadow-lg transition-all duration-200 mt-2"
                style={{ background: 'linear-gradient(to right, #800020, #A00030)' }}
              >
                Request Demo
              </button>
